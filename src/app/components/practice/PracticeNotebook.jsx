              ...
              <div className="flex-1 min-h-0 overflow-y-auto mb-3">
                {editMode === "write" ? (
                  <textarea
                    ...
                    className="w-full h-full p-4 rounded-2xl border border-slate-100 dark:border-neutral-800/80 bg-slate-50/20 dark:bg-neutral-900/30 text-sm leading-relaxed resize-none outline-none focus:border-primary/45 transition dark:text-neutral-200"
                  />
                ) : (
                  <div className="w-full h-full p-5 rounded-2xl border border-slate-50 dark:border-neutral-800 bg-slate-50/20 dark:bg-neutral-950/10 overflow-y-auto text-left leading-relaxed text-sm">
